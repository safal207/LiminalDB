...
The CI fixture runs an ephemeral Neo4j Community container with `NEO4J_AUTH=none`. Authentication and access-control behavior are outside this experiment's scope; no reusable credential is stored in the workflow.
